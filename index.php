    ...
    <header id="header" class="header-scroll top-header headrom">
        <nav class="navbar navbar-dark">
            <div class="container">
                ...
                <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/tlogo.png" alt="" width="80%"> </a>
    ...
    <section class="hero bg-image" data-image-src="images/img/pimg2.jpg">
        <div class="hero-inner">
            <div class="container text-center hero-text font-white">
                <h1>Get yar Food deliverd at your Home mann! </h1>
                ...
                <div class="steps">
                    <div class="step-item step1">
                        ...
                        <h4><span style="color:white;">1. </span>Choose ya Restaurant</h4>
                    </div>
                    ...
                    <div class="step-item step2">
                        ...
                        <h4><span style="color:white;">2. </span>Order ya Food</h4>
                    </div>
                    ...
                    <div class="step-item step3">
                        ...
                        <h4><span style="color:white;">3. </span>Pickup ya food</h4>
                    </div>
    ...
    <section class="popular">
        <div class="container">
            <div class="title text-xs-center m-b-30">
                <h2>Most Popular Dishes on tomato</h2>
                <p class="lead">Order your favourite food among these top 6 dishes on tomato</p>
            </div>
            <div class="row">
        ...
        <div class="container">
                ...
                <div class="row how-it-works-solution">
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                        <div class="how-it-works-wrap">
                            <div class="step step-1">
                                ...
                                <h3>Choose ya restaurant</h3>
                                <p>We"ve gotch ya covered with menus from a tones of restaurants online.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                        <div class="step step-3">
                            ...
                            <h3>Pick up ya food</h3>
                            <p>Get ya food delivered! And enjoy your fooood! </p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-12 text-center">
                    <p class="pay-info">COD Avilable</p>
                </div>
            </div>
        </div>
    </section>
